...
def determinePolicy(pvInfoDict):
    ...
    if userPolicyOverride == "2HzPVs" or (
        userPolicyOverride == "" and pvInfoDict["eventRate"] > 2.0
    ):
    ...
    elif userPolicyOverride == "Default" or (
        userPolicyOverride == "" and pvInfoDict["pvName"] == "mshankar:arch:sine"
    ):
        pvPolicyDict["samplingPeriod"] = 1.0
        pvPolicyDict["samplingMethod"] = "MONITOR"
        pvPolicyDict["dataStores"] = [
        ...
        userPolicyOverride == ""
        and pvInfoDict["pvName"].startswith("BPMS")
        and pvInfoDict["storageRate"] > 35
    ):
        ...
        pvPolicyDict["samplingPeriod"] = pvInfoDict["storageRate"] / (
            35 * pvInfoDict["eventRate"]
        )
        pvPolicyDict["samplingMethod"] = "MONITOR"
        pvPolicyDict["dataStores"] = [
            shorttermstore_plugin_url,
