...
Please consult [Configuration manual](https://sasaki77.github.io/archiverappliance-datasource/master/configuration.html) for instructions to configure the plugin following installation.
...
| **Regex**         | Enable/disable Regex mode. Refer [Select Multiple PVs by Regex](https://sasaki77.github.io/archiverappliance-datasource/master/query.html#select-multiple-pvs-by-regex).                                                                                                                                                                                                                                     |
...
| **Alias pattern** | Set regular expressoin pattern to use PV name for legend alias. Refer [Legend Alias with Regex Pattern](https://sasaki77.github.io/archiverappliance-datasource/master/query.html#legend-alias-with-regex-pattern)                                                                                                                                                                                           |
| **Function**      | Apply processing function for retrieved data. Refer [Apply Processing Functions](https://sasaki77.github.io/archiverappliance-datasource/master/query.html#apply-processing-functions)                                                                                                                                                                                                                       |
...
![Variables](https://sasaki77.github.io/archiverappliance-datasource/master/_images/aa-variables-settings.png)

You can use regular expression pattern same as [Query Edit](https://sasaki77.github.io/archiverappliance-datasource/master/query.html#select-multiple-pvs-by-regex).
